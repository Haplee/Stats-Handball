        ...
        <>
            <section className="relative pt-32 pb-20 px-6 overflow-hidden min-h-screen flex flex-col justify-center">
                ...
                <div className="container mx-auto max-w-5xl text-center relative z-10">
                    ...
                    >
                        Plataforma de alto rendimiento para el análisis técnico de Balonmano.
                        Tracking de precisión con YOLOv8, gestión de plantillas y pizarra táctica en una sola suite robusta.
                    </motion.p>
                    ...
                    >
                        ...
                        <Link to="/stats" className="group px-8 py-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold transition-all flex items-center justify-center gap-2">
                            Métricas de Salud <Activity size={18} className="text-blue-400" />
                        </Link>
                    </motion.div>
